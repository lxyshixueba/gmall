...
//获取到了 valueId的集合，需要去渲染到页面上
//List<BaseAttrValue> attrValueList = null;
//        for (BaseAttrInfo baseAttrInfo : baseAttrInfoList) {
//            List<BaseAttrValue> attrValueList1 = baseAttrInfo.getAttrValueList();
//            attrValueList = attrValueList1;
//        }
//        for (Iterator<BaseAttrValue> iterator = attrValueList.iterator(); iterator.hasNext(); ) {
//            BaseAttrValue next = iterator.next();
//            attrValueList.add(next);
//        }
//request.setAttribute("attrValueList", attrValueList);